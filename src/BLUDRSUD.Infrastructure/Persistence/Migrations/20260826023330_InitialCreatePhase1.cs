...
{
    /// <inheritdoc />
    public partial class InitialCreatePhase1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClosedBy = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportMapping = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AllowPosting = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ExternalCode = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RowVersion = table.Column<byte[]>(type: "longblob", rowVersion: true, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatedBy = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FundCategory = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ParentId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_fund_sources", x => x.Id);
                    table.ForeignKey(
                        name: "FK_fund_sources_fund_sources_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationType = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    HeadName = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatedBy = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastLoginIpAddress = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatedBy = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CostCenterType = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatedBy = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_cost_centers_cost_centers_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_accounting_periods_Code",
                table: "accounting_periods",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_accounting_periods_FiscalYear",
                table: "accounting_periods",
                column: "FiscalYear");

            migrationBuilder.CreateIndex(
                name: "IX_accounting_periods_FiscalYear_PeriodNumber",
                table: "accounting_periods",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_accounts_ParentId_Code",
                table: "accounts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_cost_centers_ParentId",
                table: "cost_centers",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_fund_sources_Code",
                table: "fund_sources",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_fund_sources_FundCategory",
                table: "fund_sources",
                column: "FundCategory");

            migrationBuilder.CreateIndex(
                name: "IX_fund_sources_IsActive",
                table: "fund_sources",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_fund_sources_ParentId",
                table: "fund_sources",
                column: "ParentId");
